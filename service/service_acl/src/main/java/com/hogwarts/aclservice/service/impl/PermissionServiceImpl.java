...
import com.hogwarts.aclservice.helper.MemuHelper;
import com.hogwarts.aclservice.helper.PermissionHelper;
import com.hogwarts.aclservice.mapper.PermissionMapper;
    ...
    public static List<Permission> bulidPermission(List<Permission> permissionList) {
        ...
        for(Permission p:permissionList){
            if("0".equals(p.getPid())){
                p.setLevel(1);
                finalNode.add(selectChildren(p,permissionList));
            }
        }
